...
export const ROWS = {
  ...
  wildcard: {
    ...
    cards: [
      ...
      { id: 'wildcard-learjet',  name: 'learjet',  img: 'wildcard-learjet',  caption: 'borrowed from elon, return date TBD', price: T[5], tier: 'luxury', artScale: 1.15 },
      ...
      { id: 'wildcard-island',   name: 'island',   img: 'wildcard-island',   caption: 'official escape, google maps catching up', price: T[5], tier: 'luxury', artScale: 1.15 },
      { id: 'wildcard-spa',      name: 'spa',      img: 'wildcard-spa',      caption: 'every day feels like a sunday', price: T[5], tier: 'luxury', artScale: 1.15 },
      { id: 'wildcard-rolex',    name: 'rolex',    img: 'wildcard-rolex',    caption: 'arrived exactly on time, finally', price: T[5], tier: 'luxury', artScale: 1.15 },
    ],
  },
}
