...
export const ROWS = {
  ...
  music: {
    ...
    cards: [
      ...
      { id: 'music-weeknd',    name: 'weeknd',    img: 'music-weeknd',   insert: 'weeknd',    caption: 'blinding lights, shaadi went global', price: T[3], tier: 'mid' },
      { id: 'music-zimmer',    name: 'zimmer',    img: 'music-zimmer',   insert: 'zimmer',    caption: 'your wedding, but cinema', price: T[3], tier: 'mid' },
  ...
  food: {
    ...
    cards: [
      ...
      { id: 'food-ramen',    name: 'ramen',    img: 'food-ramen',    caption: 'slurp responsibly, sherwani on your own', price: T[3], tier: 'mid' },
  ...
  wildcard: {
    ...
    withArt: true,
    cards: [
      { id: 'wildcard-paws',     name: 'paws',     img: 'wildcard-paws',     caption: 'plus-ones: furry friends only', price: T[5], tier: 'luxury' },
